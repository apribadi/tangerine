...
fn test_empty() {
  ...
  write!(s, "num_slots = {}\n", tangerine::new::internal::num_slots(&t)).unwrap();
  write!(s, "load = {}\n", tangerine::new::internal::load_factor(&t)).unwrap();
  write!(s, "allocation_size = {}\n", tangerine::new::internal::allocation_size(&t)).unwrap();
...
fn test_iter() -> Result<(), std::fmt::Error> {
  ...
  write!(s, "load = {}\n", tangerine::new::internal::load_factor(&t))?;
  write!(s, "allocation_size = {}\n", tangerine::new::internal::allocation_size(&t))?;
